...
typedef struct rf_composed_checkpoint_v3 {
    ...
    uint32_t vehicle_profile; /*0 absent,1 Driller,2 APC,3 Jeep; validated RFVC class*/
 ...
 * Actual class decoders enforce RFVC1/Driller128, RFVC2/APC128 and RFVC3/Jeep160.
