...
def main():
    ...
    report={'expected_cuts':args.expected_cuts,'no_fire':args.no_fire,'result':'FAIL','shots':args.shots,'frames':frames,'binary_sha256':hashlib.sha256(exe.read_bytes()).hexdigest(),
