...
parser=argparse.ArgumentParser();parser.add_argument('--moving',action='store_true');parser.add_argument('--tipping',action='store_true');args=parser.parse_args()
if args.tipping:args.moving=True
name='tipping' if args.tipping else 'moving' if args.moving else 'stationary'
...
if args.moving:
    ...
    assert abs(xyz[0]-(9.449 if args.tipping else 12.449))<.00001 and abs(xyz[1]-.55)<.00001 and xyz[2]==2.5
