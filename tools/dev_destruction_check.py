...
def recording(name):
    frames=800 if name=='six' else 500 if name=='approach' else 620 if name=='walk' else 400 if name=='double' else 260
    shots=(110,220,330,440,550,660) if name=='six' else () if name=='before' else (110,) if name=='single' else (110,220)
...
def main():
    ...
    for name in ('before','single','double','walk','approach','six'):
