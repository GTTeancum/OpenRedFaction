...
def main():
    ...
    manifest = {
        ...
        'schedule': ['approach10..24 toward-Z', 'Use40 to board', 'drive70..159; turn110..139',
                     'primary190..219'] + (['alternate250', 'Use340 to exit', 'neutral through419'] if args.frames == 420 else []),
        ...
        'expected': [('VEHICLE entry count1, exit count1, active0, status0' if args.frames == 420 else
                     ...
                     'VEHICLE_DAMAGE starts5000; nearby mortar blast may damage host; destroyed0/alive1 expected',
                     ...
                     'Alternate request250 should launch one mortar unless close cover rejects its muzzle'],
