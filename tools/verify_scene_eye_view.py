...
for frame,row in enumerate(rows):
    ...
    u.mem_write(entity+0x3c,data[:12]);u.mem_write(entity+0x48,data[12:48]);u.mem_write(entity+0x7e0,data[12:48])
...
(root/'artifacts/scene-eye-view-verification.json').write_text(json.dumps(report,indent=2));print(json.dumps(report,indent=2))
