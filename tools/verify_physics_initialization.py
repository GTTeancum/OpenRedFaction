 ...
 for flags in (0,1,0x80000000,0x20000):
  for mass in (1.0,2.0,8.0):
   for position in ((0,0,0),(4,-8,16)):
    ...
    cases+=1
report=dict(result='PASS',cases=cases,scope='Complete original 49ec90/49f010 and all callees with no collision-sphere mode, empty destination list, identity orientation/inertia and positive supplied mass; no hooks/intercepted effects. Selected scalar/pose/velocity/mass-product fields and unchanged parameters checked. No dynamic sphere allocation, mass generation, nonidentity inertia or shared C physics initializer.')
