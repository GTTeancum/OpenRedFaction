...
This is recovery evidence, not a reconstructed-runtime integration test.
"""
import runpy,struct,itertools,json
...
for kind,attached,room,flags,empty,seed in itertools.product((0,1),(False,True),(0,0x12345678),(0,0x10,0x200,0x210,0xffffffff),(False,True),(0,1,0x12345678,0xffffffff)):
 ...
 values=(1.25,-2.5,3.75,4.0,5.0,-6.0,0.5,0.125,2.0,0.25,1.5)
