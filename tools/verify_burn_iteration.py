...
def hook(m,address,size,context):
    ...
    if address==0x42ef3e:
        body.append(m.reg_read(UC_X86_REG_ESI));m.reg_write(UC_X86_REG_EIP,0x42f2a2);return
