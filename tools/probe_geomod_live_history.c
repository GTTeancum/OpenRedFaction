...
int main(int argc,char **argv)
{
    ...
    unsigned char *data;FILE *file;long length;uint32_t i,j,n,offset,cursor=316;char path[1024];
    ...
    rf_geomod_terrain_close(&terrain);rf_geometry_close(&geometry);rf_vpp_close(&archive);free(data);return 0;
}
