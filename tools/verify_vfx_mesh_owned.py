...
vertex_checks=0;uv_checks=0;morph_checks=0
def shared(v,global_count,budget,data,fail=False):
 global fail_alloc,vertex_checks,uv_checks,morph_checks
