...
for guard in range(3):
 ...
 if guard==0:
  ...
  struct.pack_into('<10f',wire,0,0,0,1,0,-1,-1,0,1,1,0)
  struct.pack_into('<6f',wire,136,0,0,0,0,0,0)
  struct.pack_into('<IIiIII',wire,164,0x461,0,0,0,0,0);status=-2
