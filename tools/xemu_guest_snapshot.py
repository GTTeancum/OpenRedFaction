...
def snapshot(monitor,map_text):
    ...
    for name,count in [('rf_diagnostic',58),('rf_actor_creation_diagnostic',6),('rf_scene_actor_physics_diagnostic',8),('rf_actor_world_diagnostic',8),('rf_actor_fall_diagnostic',8),('rf_scene_actor_fall_state',77),('actor_trajectory',77),('rf_scene_actor_contact',7),('rf_scene_actor_contact_time',4),('rf_scene_actor_pose',59),('rf_scene_actor_render_frames',320),('resident_miner_config',117),('scene_actor_body',81)]:
