...
def snapshot(monitor,map_text):
    ...
    for name,count in [('rf_scene_alarm',12),('rf_scene_switch_runtime',8),('rf_scene_switch_detail',8),('rf_scene_switch_history',4),('rf_scene_trigger_history',4),('rf_scene_startup_inventory',4),('rf_scene_player_ammo',8),('rf_scene_pickups',8),('rf_scene_script_grants',8),('rf_scene_riot',8),('rf_xbox_world_groups',2),('rf_xbox_command_blocks',6),('rf_xbox_bounds_poses',2),('rf_xbox_model_visibility',8),('rf_scene_pose_sharing',4),('rf_scene_death_watches',97),('rf_scene_watch_test',4),('rf_scene_script_movement',8),('rf_scene_actor_revisit',8),('rf_scene_script_attack',12),('rf_scene_enemy_aim',4),('rf_scene_enemy_fire',6),('rf_scene_enemy_retaliation',4),('rf_scene_script_actor',8),('rf_scene_script_routes',8),('rf_scene_npc_triggers',6),('rf_scene_actor_retirement',4),('rf_scene_defeated_actors',8194),('rf_scene_campaign_pickups',5122),('rf_scene_campaign_load_stage',1),('rf_scene_mission_goals',4225),('rf_xbox_load_stage',1),('rf_xbox_level_transitions',4),('rf_player_replay_diagnostic',4),('rf_preview_failure',8),('rf_animation_progress',4),('rf_animation_render_memory',4),('rf_renderer_profile',32),('rf_renderer_submission',4),('rf_renderer_vblank',3),('rf_scene_profile',32),('rf_scene_presentation_profile',32),('rf_scene_world_profile',32),('rf_scene_step_profile',32),('rf_scene_npc_step_profile',32),('rf_scene_npc_playback_profile',32),('rf_scene_profile_stage',2),('rf_player_frame_clock',8),('rf_diagnostic',58),('rf_actor_creation_diagnostic',6),('rf_scene_actor_physics_diagnostic',8),('rf_actor_world_diagnostic',8),('rf_actor_fall_diagnostic',8),('rf_scene_actor_fall_state',77),('rf_scene_actor_initial_state',77),('rf_scene_actor_tick_stats',8),('rf_scene_actor_contact',7),('rf_scene_actor_contact_time',4),('rf_scene_actor_pose',59),('rf_scene_actor_render_frames',320),('resident_miner_config',117),('scene_actor_body',81)]:
        match=re.search(r'_'+name+r'\s+([0-9a-fA-F]+)',map_text)
    ...
    for name,command in [('registers','info registers'),('instructions','x /12i $eip'),('stack','x /256wx $esp')]:
