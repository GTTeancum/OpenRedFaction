...
report=dict(result='PASS',retained_bytes=93434,post_close_pcm_hash=hash_,scope='PC VPP bank: exact/one-byte-short budgets, case-insensitive deduplication with first-registration spatial parameters, missing file and output preservation, playback data after archive close, invalid sample index, repeat bank close, explicit unload/reload with preserved parameters/index, exact byte reclamation, closed-archive and one-byte-short reload rejection, and restored PCM after archive reopen/close. First256 stereo frames match independent Python wave/integer interpolation. NXDK build only for ownership; no live device output or automatic eviction policy.')
