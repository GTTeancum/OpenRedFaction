...
public class ExportBaseline extends GhidraScript {
    public void run() throws Exception {
        ...
        // Inventory/AI initialization and player class lookup before first pose selection.
        for (long target : new long[]{0x402c20L,0x409050L,0x4251c0L,0x42ab20L,0x4339d0L,0x433a00L}) addresses.add(target);
        ...
        addresses.add(0x464010L); // Entity-section loader called at 461006.
        for (long target : new long[]{0x487100L,0x40e380L,0x40e600L}) addresses.add(target);
        ...
        for(long target : new long[]{0x433260L,0x433520L,0x433670L,0x433a50L}) addresses.add(target);
