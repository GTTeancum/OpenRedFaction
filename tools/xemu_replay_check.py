...
if args.setup_uid is not None:replay_env['RF_REPLAY_SETUP_UID']=str(args.setup_uid)
...
try:
 ...
 else:setup_file.write_bytes(args.setup_uid.to_bytes(4,'little'))
