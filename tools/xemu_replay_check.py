...
if args.setup_uid is not None and (not args.goto_uid or len(args.setup_uid)>2 or any(not 0<x<0xffffffff for x in args.setup_uid)):p.error('--setup-uid requires --goto-uid and a positive UID')
