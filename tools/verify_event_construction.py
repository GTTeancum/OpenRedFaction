"""Original door-event constructors against patterned storage; no registration."""
...
results=[]
for kind,address,size,vtable in [(6,0x4be510,0x2bc,0x58995c),(30,0x4be8a0,0x2bc,0x589a7c),(50,0x4becb0,0x2c0,0x589bec)]:
 for fill in (0,0xa5):
