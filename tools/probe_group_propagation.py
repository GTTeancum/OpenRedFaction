...
for n in range(2000):
 ...
 for i in range(count):
  ...
  for j,offset in enumerate([0x2cc,0x2c0]):
   ...
   if refs[0]==handle and (j==0 or not flags&0x8000000):contributions.append([f32(a-b) for a,b in zip(pending,first)]);dirty|=bool(control_flags&0x80000008)
