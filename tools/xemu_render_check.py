...
def main():
    ...
    parser.add_argument('--vehicle-class', choices=('driller','apc'), default='driller', help='Vehicle class for --vehicle-test')
    ...
    if args.vehicle_test:env['RF_REPLAY_VEHICLE']='apc' if args.vehicle_class=='apc' else '1'
    ...
    try:
        ...
        if args.vehicle_test:(disc/'vehicle-test.flag').write_text('2' if args.vehicle_class=='apc' else '1')
