...
def main():
    ...
    parser.add_argument('--authored-source', type=int, choices=(66,92,93,94,95,96,97,98,108), help='Select one ctf06 developer destruction source on both platforms')
    ...
    if args.authored_source in (66,92,108) and args.authored_sources!=1:
        parser.error('Sources66/92/108 require a single source')
