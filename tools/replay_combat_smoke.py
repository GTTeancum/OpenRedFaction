...
for name,frames,fire,reload in [('idle',180,False,False),('fire',360,True,False),('reload',180,True,True)]:
 ...
 env=dict(os.environ,RF_REPLAY_ACTOR_UID='9858',RF_REPLAY_LEVEL='L1S1.rfl',RF_REPLAY_ARCHIVE='levels1.vpp')
...
report=dict(result='PASS',cases=rows,scope='Staged real L1S1 miner9858, manual/automatic reload, repeated trigger and retained damage/death on PC. Prototype tuning, finite clip/unlimited reserves. Static world rays and conservative moving-solid bounds; AABB actor hits. No enemy return fire, shot audio, first-person weapon presentation or full weapon inventory claim.')
