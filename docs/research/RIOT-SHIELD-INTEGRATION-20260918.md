...
Remaining: live blocking/break demonstration and Xbox encounter, other NPC direct rays, shield contact outside body silhouette, player-held shield, pickup/refill and persistence. The adapter is level-local and does not claim persistent durability across visits.
