...
int main(void)
{
    ...
    for(i=0;i<2;i++){items[i].object_kind=6;items[i].authored=authored+i;items[i].state.deadline=-1;
    ...
    puts("PASS Play_Sound immediate, delayed, off and missing-service dispatch");return 0;
}
