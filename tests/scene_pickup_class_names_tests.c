...
int main(int argc,char **argv)
{
    ...
    static const char *weapons[]={"12mm handgun","Assault Rifle","Riot Stick","Shotgun","Rocket Launcher","Grenade","Sniper Rifle","rail_gun","Remote Charge","Remote Charge Detonator","Flamethrower","riot shield"};
    static const unsigned char gives[]={1,1,1,1,1,1,0,0,0,1,0,1};
    static const char *extra[]={"Machine Pistol","heavy_machine_gun","scope_assault_rifle","heavy_machine_gun","scope_assault_rifle"};
