...
{
    static const uint32_t uids[7]={93,94,96,97,95,98,66};
    unsigned char digests[7][32],repeat[32],windows[7][32];uint32_t n,i,j,peak;
    for(n=0;n<7;n++) {
        ...
        CHECK(asset.windows.face_count==(uids[n]==66?134:(uids[n]==95 || uids[n]==98)?8:4));
